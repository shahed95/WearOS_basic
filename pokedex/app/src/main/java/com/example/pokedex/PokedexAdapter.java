...
public class PokedexAdapter extends RecyclerView.Adapter<PokedexAdapter.PokedexViewHolder> {
    ...
    private List<Pokemon> pokemon = Arrays.asList(
            new Pokemon("Sakib", "0171231231"),
            new Pokemon("Tamim", "0171221231"),
            new Pokemon("Mashrafe", "0171231231"),
            new Pokemon("Musfiq", "0171232222"),
            new Pokemon("Riyad", "0132232222"),
            new Pokemon("Liton", "0132444222"),
            new Pokemon("Soumya", "0132444312"),
            new Pokemon("Mustafiz", "01324232322")
    );
    @Override
    public void onBindViewHolder(@NonNull PokedexViewHolder holder, int position) {
        Pokemon current = pokemon.get(position);
        holder.textView.setText(current.getName());
        holder.phoneNo.setText(current.getNumber());
